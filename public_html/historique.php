...
/* Hero — pleine largeur, contenu centré, sans décalage */
.page-historique .hist-hero{margin-top:0;}
.hist-hero{position:relative;text-align:center;overflow:hidden;background:linear-gradient(180deg,rgba(0,212,255,0.05) 0%,transparent 100%);border-bottom:1px solid var(--border,rgba(255,45,120,0.15));margin:0;padding:2.5rem 2rem;width:100%;box-sizing:border-box;}
...
@media(max-width:768px){
  .hist-hero{padding:1.5rem 0.8rem !important;}
...
<div class="hist-hero<?= $membre ? ' full-bleed' : '' ?>">
