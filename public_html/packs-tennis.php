...
.pk-hero .badge{display:inline-block;background:linear-gradient(135deg,#39ff14,#00d46a);color:#fff;padding:.4rem 1.2rem;border-radius:20px;font-family:'Orbitron',sans-serif;font-size:.7rem;font-weight:700;letter-spacing:1.5px;text-transform:uppercase;margin-bottom:1rem}
.pk-hero h1{font-family:'Orbitron',sans-serif;font-size:clamp(1.8rem,4vw,2.8rem);font-weight:900;background:linear-gradient(135deg,#39ff14,#00d46a);-webkit-background-clip:text;-webkit-text-fill-color:transparent;margin:0 0 .8rem}
...
.pk-solde b{font-size:1.4rem;color:#39ff14}
.pk-card{position:relative;background:rgba(12,10,20,0.92);border:2px solid #39ff1440;border-radius:20px;padding:2.5rem 2rem;text-align:center;overflow:hidden;transition:transform .3s}
.pk-card:hover{transform:translateY(-4px);box-shadow:0 20px 60px #39ff1420}
.pk-card::after{content:'';position:absolute;bottom:0;left:0;right:0;height:3px;background:linear-gradient(90deg,#39ff14,#00d46a)}
...
.pk-price{font-family:'Orbitron',sans-serif;font-size:3.5rem;font-weight:900;color:#fff;margin-bottom:.3rem}.pk-price span{font-size:1.5rem;color:#39ff14}
...
.pk-btn-cb{background:linear-gradient(135deg,#39ff14,#00d46a);color:#000}.pk-btn-cb:hover{transform:translateY(-2px);box-shadow:0 8px 20px #39ff1440}
...
<div class="pk-wrap">
  <div class="pk-hero">
    ...
    <h1>Tennis Premium</h1>
    <p>Analyse tennis ultra-poussée — méthodologie BASELINE SYNDICATE</p>
  ...
  <div class="pk-info">
    <strong style="color:#39ff14">À vie</strong> — ton crédit n'expire jamais. Utilise-le quand un bet Tennis Premium t'intéresse, gratuitement à la reconsultation.
  </div>
</div>
