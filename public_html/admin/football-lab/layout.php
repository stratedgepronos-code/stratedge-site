...
function lab_start(string $title, string $active): void {
    ...
    $descriptions = ['import' => 'Charge tes deux exports PackBall GPT et GPT-2, retrouve tes analyses.', 'analyses' => 'Compare les marchés. Examine le contexte. Construis ta sélection.', 'history' => 'Confronte les probabilités aux résultats, match après match.'];
