...
function stratedge_card_css($theme, $conf_pct) {
    ...
    $css .= ".pick-accent{font-family:'Instrument Serif',serif;font-style:italic;font-size:30px;color:$accent;text-shadow:0 0 10px rgba($rgb,.5);letter-spacing:.05em;word-spacing:.1em;padding-left:2px;font-feature-settings:'kern' 0,'tnum' 1,'lnum' 1;font-variant-numeric:tabular-nums lining-nums;font-kerning:none}";
    ...
    if ($is_combi) {
        ...
        foreach ($matches as $m) {
            ...
            $pick_svg = "<svg class='combi-pick-svg' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 $pick_vb_w 26' preserveAspectRatio='xMinYMid meet'>"
                      . "<text x='0' y='19' font-family=\"'Instrument Serif', Georgia, serif\" font-style='italic' font-size='18' fill='#ede8e0' opacity='.85' letter-spacing='0.9' font-kerning='none' xml:space='preserve'>$pick_raw</text>"
                      . "</svg>";
