...
['type'=>'weekend','tier'=>'Recommandé','name'=>'Week-End','video'=>'/assets/images/air.mp4','price'=>'10','period'=>'/ souscription (ven → dim)','color'=>'#ff2d78','dim'=>'#d6245f','glow'=>'rgba(255,45,120,0.20)','grad'=>'linear-gradient(135deg,#ff2d78,#d6245f)','featured'=>true,'discount'=>'-10% JEU.','features'=>['<span style="white-space:nowrap;">Accès bets "Safe" &amp; "Fun"</span><br><span class="fun-supplement-pulse">Fun bets avec supplément</span>','Du vendredi au dimanche','Bets LIVE par mail &amp; Push','Idéal pour les matchs du week-end'],'link'=>'offre-weekend.php','btn'=>'💳 Payer — 10€','info'=>'CB · PayPal · Paysafecard · Internet+ via StarPass'],
