...
.plan-features{list-style:none;padding:0;margin:0 0 1.5rem}.plan-features li{padding:.45rem 0;color:var(--txt2);font-size:.92rem;display:flex;align-items:center;gap:.7rem}.plan-features li::before{content:'✓';color:var(--cc);font-weight:700;flex-shrink:0}
...
.vip-features{list-style:none;padding:0;margin:0 0 1.5rem;text-align:left}.vip-features li{padding:.45rem 0;color:rgba(245,200,66,0.7);font-size:.92rem;display:flex;align-items:center;gap:.7rem}.vip-features li::before{content:'★';color:#ffd700;font-weight:700;flex-shrink:0;font-size:.8rem}
...
/* TENNIS */
.tennis-card{background:var(--card,#111827);border:1px solid rgba(0,212,106,0.35);border-radius:20px;padding:2.2rem 2.5rem;display:grid;grid-template-columns:auto 1fr auto;gap:2.5rem;align-items:center;position:relative;overflow:hidden;transition:all .3s;box-shadow:0 0 40px rgba(0,212,106,0.06)}.tennis-card::before{content:'';position:absolute;inset:0;background:linear-gradient(135deg,rgba(0,212,106,0.04),transparent 60%);pointer-events:none}.tennis-card:hover{box-shadow:0 20px 60px rgba(0,212,106,0.12);transform:translateY(-4px)}
.tennis-badge{position:absolute;top:1rem;left:1.5rem;font-family:'Orbitron',sans-serif;font-size:.55rem;font-weight:700;letter-spacing:2px;text-transform:uppercase;background:rgba(0,212,106,0.1);border:1px solid rgba(0,212,106,0.3);color:#00d46a;padding:.25rem .8rem;border-radius:20px;z-index:5}
.tennis-mascot{width:140px;height:140px;border-radius:50%;overflow:hidden;border:2px solid rgba(0,212,106,0.4);box-shadow:0 0 30px rgba(0,212,106,0.2);flex-shrink:0}.tennis-mascot video{width:100%;height:100%;object-fit:cover}
.tennis-info{padding-top:.5rem}.tennis-tag{font-family:'Space Mono',monospace;font-size:.65rem;letter-spacing:3px;text-transform:uppercase;color:#00d46a;margin-bottom:.3rem}.tennis-title{font-family:'Orbitron',sans-serif;font-size:1.5rem;font-weight:700;margin-bottom:.8rem}.tennis-price-row{display:flex;align-items:baseline;gap:.5rem;margin-bottom:.8rem}.tennis-price{font-family:'Orbitron',sans-serif;font-size:2.5rem;font-weight:900;color:#00d46a;line-height:1}.tennis-price sup{font-size:1rem}.tennis-per{font-size:.85rem;color:var(--txt3,#8a9bb0)}.tennis-features{list-style:none;padding:0;margin:0}.tennis-features li{padding:.3rem 0;color:var(--txt2,#b0bec9);font-size:.9rem;display:flex;align-items:center;gap:.6rem}.tennis-features li::before{content:'✓';color:#00d46a;font-weight:700}
.tennis-payment{text-align:center;min-width:200px}.tennis-pay-label{font-family:'Space Mono',monospace;font-size:.65rem;color:#00d46a;letter-spacing:2px;text-transform:uppercase;margin-bottom:.7rem}
.tennis-btn{display:block;width:100%;padding:.8rem 1.5rem;background:linear-gradient(135deg,#00d46a,#00a852);color:#fff;border:none;border-radius:8px;font-family:'Rajdhani',sans-serif;font-size:1rem;font-weight:700;text-transform:uppercase;letter-spacing:1px;cursor:pointer;text-decoration:none;transition:all .3s;text-align:center;box-shadow:0 4px 15px rgba(0,212,106,0.3)}.tennis-btn:hover{box-shadow:0 6px 25px rgba(0,212,106,0.5);transform:translateY(-2px)}
...
['type'=>'weekend','tier'=>'Recommandé','name'=>'Week-End','video'=>'/assets/images/air.mp4','price'=>'10','period'=>'/ souscription (ven → dim)','color'=>'#ff2d78','dim'=>'#d6245f','glow'=>'rgba(255,45,120,0.20)','grad'=>'linear-gradient(135deg,#ff2d78,#d6245f)','featured'=>true,'discount'=>'-10% JEU.','features'=>['Accès bets "Safe" &amp; "Fun"','Du vendredi au dimanche','Bets LIVE par mail &amp; Push','Idéal pour les matchs du week-end'],'link'=>'offre-weekend.php','btn'=>'💳 Payer — 10€','info'=>'CB · PayPal · Paysafecard · Internet+ via StarPass'],
...
<!-- Tennis -->
<div class="tennis-card" style="animation:fU .7s ease .45s both">
<div class="tennis-badge">🎾 NOUVEAU — BET TENNIS</div>
<?php if(in_array('tennis',$typesActifs)):?><div class="active-tag">✓ ACTIF</div><?php endif;?>
<div class="tennis-mascot"><video autoplay loop muted playsinline><source src="/assets/images/mascotte_tennis.mp4" type="video/mp4"></video></div>
<div class="tennis-info"><div class="tennis-tag">Spécialité Tennis</div><div class="tennis-title">🎾 Tennis Weekly</div><div class="tennis-price-row"><div class="tennis-price"><sup>€</sup>15</div><div class="tennis-per">/ semaine</div></div>
<ul class="tennis-features"><li>Analyses ATP &amp; WTA en exclusivité</li><li>Bets Safe &amp; Fun Tennis</li><li>7 jours d'accès complet</li><li>Notifications Push &amp; Email</li></ul></div>
