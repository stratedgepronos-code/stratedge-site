...
<head>
  ...
  <style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .giveaway-badge { margin-top: 0.7rem; padding: 0.55rem 0.8rem; border-radius: 10px; border: 1px solid transparent; position: relative; text-align: center; animation: giveawayPulse 3s ease-in-out infinite; background: linear-gradient(135deg, rgba(255,45,120,0.08), rgba(0,212,255,0.08)) padding-box, linear-gradient(135deg, #ff2d78, #a855f7, #00d4ff) border-box; }
    .giveaway-shimmer { position: absolute; inset: 1px; border-radius: 9px; overflow: hidden; pointer-events: none; z-index: 1; }
    .giveaway-shimmer::after { content: ''; position: absolute; top: 0; left: -100%; width: 50%; height: 100%; background: linear-gradient(90deg, transparent, rgba(255,255,255,0.06), transparent); animation: gwShimmer 3s ease-in-out infinite; }
    @keyframes gwShimmer { 0%,100% { left: -50%; } 50% { left: 100%; } }
  ...
  <div class="pricing-grid">
    ...
    <div class="price-card fade-up">
      ...
      <div class="starpass-zone">
        ...
        <?php endif; ?>
        <div class="giveaway-badge"><div class="giveaway-shimmer"></div>
