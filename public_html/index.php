...
<head>
  ...
  <style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .hero-inner { max-width: 1440px; width: 100%; margin: 0 auto; position: relative; z-index: 5; padding: 90px 3rem 3rem 0.5rem; display: flex; flex-direction: column; justify-content: center; align-items: flex-start; }
