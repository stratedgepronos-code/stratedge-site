...
<head>
  ...
  <style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .hero-inner { max-width: 1440px; width: 100%; margin: 0 auto; position: relative; z-index: 5; padding: 0 5rem; padding-top: 90px; padding-bottom: 3rem; display: flex; flex-direction: column; justify-content: center; align-items: flex-start; }
    ...
    .hero-visual { position: absolute; bottom: 0; top: auto; right: 2%; left: auto; transform: scale(1.12); transform-origin: bottom right; z-index: 2; pointer-events: none; width: 980px; height: 1140px; }
    .mascot-container { position: relative; width: 980px; height: 1140px; }
    ...
    .mascot-img { position: absolute; bottom: 0; top: auto; left: 50%; transform: translateX(-50%); width: 980px; height: auto; filter: drop-shadow(0 0 80px rgba(255,45,120,0.35)); animation: hero-mascot-breathe 4.5s ease-in-out infinite, hero-mascot-eyes 3.2s ease-in-out infinite; }
