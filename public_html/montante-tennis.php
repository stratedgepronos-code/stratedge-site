...
/* Visuel pleine largeur — full-bleed avec sidebar (même logique que bets-hero / hist-hero), remonté pour tout voir */
.mt-promo-visual{margin-left:-3rem;margin-right:-3rem;width:calc(100% + 6rem);margin-top:-2rem;margin-bottom:2rem;padding:2rem 2rem;background:linear-gradient(135deg,rgba(0,212,255,0.06) 0%,rgba(255,45,120,0.04) 40%,rgba(0,212,106,0.08) 100%);border-top:1px solid rgba(255,255,255,0.06);border-bottom:1px solid rgba(0,212,106,0.15);position:relative;overflow:hidden;}
...
@media(max-width:768px){
  ...
  .mt-promo-visual{margin-left:-0.8rem;margin-right:-0.8rem;margin-top:-1.5rem;width:calc(100% + 1.6rem);padding:1.25rem 1rem;}
