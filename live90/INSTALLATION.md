# V3 : lire GUIDE_DEV_V3.md en premier

Les instructions de configuration IA de la V2 sont remplacées. Le moteur V3 exige un dossier de scénarios et ne fait aucun appel OpenAI. Le protocole fixe V1 ci-dessous décrit uniquement l’ancien module, pas les règles actives de la V3.

# SEUIL 90 · Live Console — 2.0.0

**V2 : lire `CONTEXTE_IA.md` en premier.** Le récepteur et les critères statistiques ci-dessous restent ceux de la V1 ; les alertes nécessitent désormais un dossier avant-match sourcé et une lecture live IA. Pour un serveur avec V1 déjà installée, utiliser `update.sh`.
